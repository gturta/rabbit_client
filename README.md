...
The consumer will save it's current offset in the stream in a local `sled` db stored in `/tmp/rabbit_consumer_storage`.
...
I have also ran the test with offset saving disabled, just to see the speed impact.
